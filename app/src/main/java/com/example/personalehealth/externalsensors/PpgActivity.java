...
public class PpgActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plot2.setRangeBoundaries(0, 2, BoundaryMode.FIXED);
        ...
        if (testInitiated) {
            try {
                ...
                text_reading.setText(Html.fromHtml(
                        "<font color='#ff9052'><b>PPG :</b>" + ppg + "<br></font>"
                ));
        ...
        protected Void doInBackground(Void... paramses) {
            try {
                ...
                while (counter < 100) {
                    ...
                    BitalinoActivity.ECGModel ppgSerires = new BitalinoActivity.ECGModel(arrayPPg.length,20);
                    // add a new series' to the xyplot:
                    BitalinoActivity.MyFadeFormatter formatter1 = new BitalinoActivity.MyFadeFormatter(2000);
